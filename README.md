...
```javascript
import { arcsine, bernoulli, beta, betaprime, cosine, discreteUniform, exponential, gamma, geometric, invgamma, lognormal, minstd, minstdShuffle, mt19937, normal, poisson, randu, rayleigh, uniform } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array@deno/mod.js';
```
