...
```javascript
import { arcsine, bernoulli, beta, betaprime, cauchy, chi, chisquare, cosine, discreteUniform, erlang, exponential, f, gamma, geometric, gumbel, invgamma, lognormal, minstd, minstdShuffle, mt19937, normal, poisson, randu, rayleigh, t, uniform } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array@deno/mod.js';
```
